...
(function(){
    ...
    vCode.prototype.drawCode = function(code, index){
        ...
        dom.style.cssText = [
            ...
            "top:" + randint(0, this.h - 48) + "px",
            "transform:rotate(" + randint(-48, 48) + "deg)",
            "-ms-transform:rotate(" + randint(-48, 48) + "deg)",
            "-moz-transform:rotate(" + randint(-48, 48) + "deg)",
            "-webkit-transform:rotate(" + randint(-48, 48) + "deg)",
            "-o-transform:rotate(" + randint(-48, 48) + "deg)",
